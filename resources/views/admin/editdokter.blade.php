...
<div class="row justify-content-center mb-5">
  <div class="col-11 info-panel mb-5">
      <div class="row">
          <form method="POST" action="/dokters/{{ $dokter->id }}">
            @method('put')
            @csrf
            <h4 class="text-center mb-3">EDIT DATA DIRI DOKTER</h4>
            <div class="form-group col-12 mb-3">
              <label class="fw-bold" for="kd_dokter">NIP</label>
              <input type="text" name="kd_dokter" class="form-control radius @error('kd_dokter') is-invalid @enderror" value="{{ old('kd_dokter', $dokter->kd_dokter) }}">
              @error ('kd_dokter')
            ...
            <div class="form-group col-12 mb-3">
              ...
              <input type="nmdokter" name="nmdokter" class="form-control radius @error('nmdokter') is-invalid @enderror" value="{{ old('nmdokter', $dokter->nmdokter) }}">
              @error ('email')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="form-group col-6 mb-3">
              ...
              @if (old('ahli_id',$dokter->ahli_id) == $ahli->id)
