      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="md-4 pe-md-12 d-flex">
              <form action="/pengajuans">
                <div class="row">
            ...
            <div class="table-responsive p-0">
              ...
              <table class="table align-items-center mb-0">
                <div class="tambah" style="width: 15%; text-align: left; float: right;">
                  ...
                  {{-- <a href="/exportpengajuan" class="btn btn-warning border-0">
                    Export Data
                  </a> --}}
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <p class="text-xs font-weight-bold mb-0">{{ $pengajuan->created_at->format('d-m-Y') }}</p>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <a href="/pengajuans/{{ $pengajuan->id }}" class="btn btn-link btn-sm mb-0">
                        Detail
                      </a>
                    </td>
                  </tr>
              ...
              @else
                  <p class="text-center fs-6">Data pengajuan tidak ditemukan....</p>
              @endif
            </div>
          </div>
