...
<div class="row justify-content-center mb-5">
  <div class="col-11 info-panel mb-5">
      <div class="row">
          <form method="POST" action="/ahlis/{{ $ahli->id }}">
            @method('put')
            @csrf
            <h4 class="text-center mb-3">BIDANG AHLI</h4>
            <div class="form-group col-12 mb-3">
              <label class="fw-bold" for="bidangahli">Bidang Ahli</label>
              <input type="text" name="bidangahli" class="form-control radius @error('bidangahli') is-invalid @enderror" value="{{ old('bidangahli', $ahli->bidangahli) }}">
              @error ('bidangahli')
